...
from .t5_tokenization import T5Tokenizer, GPT2TokenizerwoMerge
...
def build_tokenizer(args):
    ...
    elif args.tokenizer_type == 'T5Tokenizer':
        tokenizer = _T5Tokenizer(os.path.join(args.vocab_file, 'vocab.txt'))
        # tokenizer = EncDecTokenizer(, os.path.join(args.tokenizer_path, 'chinese_vocab.model'))
    else:
...
class _T5Tokenizer(AbstractTokenizer):
    """Original GPT2 BPE tokenizer."""
    ...
    def get_sentinel_num(self):
        return self.tokenizer.get_sentinel_num()

    def get_sentinel_id(self, idx):
        return self.tokenizer.get_sentinel_id(idx)