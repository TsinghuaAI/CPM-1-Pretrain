...
def _add_network_size_args(parser):
    ...
    group.add_argument('--hidden-size', type=int, default=None,
                       help='Tansformer hidden size of input.')
    group.add_argument('--kv-hidden-size', type=int, default=None,
                       help='Tansformer hidden size of each head.')
    group.add_argument('--ff-hidden-size', type=int, default=None,
                       help='Tansformer hidden size of each linear layer.')
...
def _add_training_args(parser):
    ...
    group.add_argument('--hidden-bias', action='store_true',
                       help='Enable bias in linear layers.')
...
def _add_data_args(parser):
    ...
    group.add_argument('--enc-seq-length', type=int, default=None,
                       help="Maximum sequence length to process for encoder.")
    group.add_argument('--dec-seq-length', type=int, default=None,
                       help="Maximum sequence length to process for decoder.")
